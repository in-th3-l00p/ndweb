...
export const pageContent = {
  ...
  hero: {
    badge: {
      ...
      text: 'Get in touch',
      link: 'mailto:nedeleadavid22@yahoo.com',
    },
  ...
  socialLinks: [
    {
      name: 'Instagram',
      value: '@_david.stefan_',
      url: 'https://www.instagram.com/_david.stefan_?igsh=MXNxMHhjZHd5YnZmbQ%3D%3D&utm_source=qr',
      platform: 'instagram',
      showInFooter: true,
      showInContact: true,
    },
    {
      name: 'TikTok',
      value: '@davidmotiveaza',
      url: 'https://www.tiktok.com/@davidmotiveaza?_r=1&_t=ZN-9713OUO2TMU',
      platform: 'tiktok',
      showInFooter: true,
      showInContact: true,
    },
    {
      name: 'Email',
      value: 'nedeleadavid22@yahoo.com',
      url: 'mailto:nedeleadavid22@yahoo.com',
      platform: 'email',
      showInFooter: true,
      showInContact: true,
    },
