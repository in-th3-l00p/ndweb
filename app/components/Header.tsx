  ...
  return (
    ...
    >
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        />
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full sm:max-w-sm">
          <motion.div
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
            transition={{ type: 'spring', damping: 30, stiffness: 300 }}
            className="h-full w-full overflow-y-auto bg-white p-6 sm:ring-1 sm:ring-gray-900/10"
          >
